...
public class Emails
{
    public static async Task<int> SendPasswordRestLink(string name, string emails, string link)
    {
        try
        {
            ...
            mail.Subject = "NextWebi Admin  Reset Password";
...
<head>
    ...
    <title>Qlux </title>
    <link rel='shortcut icon' href='https://www.Qlux /images/Nextwebi-sq_Black_Logo2_1_140x.png' />
                                                                    ...
                                                                    <table border='0' cellpadding='0' cellspacing='0' style='float:left;width: 100%;margin-right:5%'>
                                                                        <tr>
                                                                            <td align='left' valign='top' width='100%' style='vertical-align: middle;' class='flexibleContainerCell'>
                                                                                <center>
                                                                                    <img style='width:110px;margin-bottom:0px;' src='" + ConfigurationManager.AppSettings["domain"] + @"/img/email-qlux-logo.png' />
                                                                                </center>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    ...
                                                                    <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                                                        <tr>
                                                                            <td align='left' valign='top' width='100%' class='flexibleContainerCell'>
                                                                                ...
                                                                                <p style='font-size:15px;color:#000;line-height:22px!important;margin-bottom:5px;text-align:center;padding:0px 20px !important'>Hello " + name + @". We have just received a request to reset your password for the Qlux  account.<br><br></p>
                                                                            ...
                                                                            <td align='center' valign='top' width='100%' class='flexibleContainerCell'>
                                                                                <ul style='list-style:none;width:400px;margin:0px auto;'>
                                                                                    <li style='display:inline-block;margin-right:10px;border-right:2px solid #ccc;padding-right:14px;'>
                                                                                        <a href='https://www.facebook.com/pages/category/Brand/Qlux -1404212866358535/' target='_blank'><img width='30' src='" + ConfigurationManager.AppSettings["domain"] + @"/img/facebook.png' /></a>
                                                                                    </li>
                                                                                   
                                                                                    <li style='display:inline-block;margin-right:10px;border-right:2px solid #ccc;padding-right:14px;'>
                                                                                        <a href='https://www.instagram.com/Qlux lifestyles/?hl=en' target='_blank'><img width='30' src='" + ConfigurationManager.AppSettings["domain"] + @"/img/instagram.png' /></a>
                                                                                    </li>
...
<a href='" + strlink + @"' style='padding: 10px 30px;background: #e7757f;text-decoration: none;color: #fff;font-size: 20px;'>Verify Email</a>
    <p style='font-size: 14px;line-height:22px!important;text-align:center;margin-top: 20px;color:#573e40;margin-bottom:30px;'>If clicking the button does not work, copy the URL below and paste it into your browser:<br>" + strlink + @"<br><br></p></td><tr>
                                                                    ...
                                                                    <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                                                        <tr>
                                                                            <td align='center' valign='top' width='100%' class='flexibleContainerCell'>
                                                                                <ul style='list-style:none;width:400px;margin:0px auto;'>
                                                                                    <li style='display:inline-block;margin-right:10px;border-right:2px solid #ccc;padding-right:14px;'>
                                                                                        <a href='https://www.facebook.com/pages/category/Brand/Qlux -1404212866358535/' target='_blank'><img width='30' src='" + ConfigurationManager.AppSettings["domain"] + @"/img/email-icons/facebook.png' /></a>
                                                                                    </li>
                                                                                    <li style='display:inline-block;margin-right:10px;border-right:2px solid #ccc;padding-right:14px;'>
                                                                                    ...
                                                                                    <li style='display:inline-block;margin-right:10px;border-right:2px solid #ccc;padding-right:14px;'>
                                                                                        <a href='https://www.instagram.com/Qlux lifestyles/?hl=en' target='_blank'><img width='30' src='" + ConfigurationManager.AppSettings["domain"] + @"/img/email-icons/instagram.png' /></a>
                                                                                    </li>
                                                                                    <li style='display:inline-block;margin-right:0px;'>
                                                                                        <a href='https://twitter.com/Qlux Retail' target='_blank'><img width='30' src='" + ConfigurationManager.AppSettings["domain"] + @"/img/email-icons/twitter.png' /></a>
                                                                                    </li>
                                                                                </ul>
                                                                            </td>
                                                                        </tr>
            ...
            mail.To.Add(email);
            mail.From = new MailAddress(ConfigurationManager.AppSettings["from"], ConfigurationManager.AppSettings["fromName"]);
            mail.Subject = "Qlux  Account verification";
            mail.Body = mailBody1;
            mail.IsBodyHtml = true;
            SmtpClient smtp = new SmtpClient();
            smtp.Host = ConfigurationManager.AppSettings["host"];
    ...
    public static async Task<int> SendPasswordReset(string name, string email, string custId)
    {
        try
        {
            ...
            mail.From = new MailAddress(ConfigurationManager.AppSettings["from"], "Qlux  Password Reset");
                                                                    ...
                                                                    <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                                                        <tr>
                                                                            <td align='left' valign='top' width='100%' class='flexibleContainerCell'>
                                                                                <p style='font-size:22px;line-height:32px!important;text-align:center;color:white;margin-top:0px;background:#cd6c73;padding:10px;'>PASSWORD RESET</p>
                                                                                <p style='font-size:20px;line-height:28px!important;text-align:center;color:#000;font-weight:bold!important'>Request for password reset!</p>
                                                                                <p style='font-size:14px;color:#000;line-height:22px!important;margin-bottom:5px;text-align:center;padding:0px 20px !important'>Hello " + name + @", <br>We have just received a request to reset your password for the Qlux  account.</p>
